...
postForm("http://192.168.1.16:3000/settings");
setEventListeners();

ipcRenderer.on("information-dialog-selection", (event, index) => {
  if (index === 0) {
    postForm("http://192.168.1.16:3000/initialization");
  }
});
...
function setEventListeners() {
  initBtn.addEventListener("click", event => {
    postForm("http://192.168.1.16:3000/synchronization");
  ...
  subBtn.onclick = function(e) {
    ...
    //console.log(data)
    postForm("http://192.168.1.16:3000/settings", data);
  };
